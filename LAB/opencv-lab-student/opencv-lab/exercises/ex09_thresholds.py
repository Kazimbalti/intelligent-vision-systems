...
_, glob = None, None  # TODO 1: global threshold at 127

# STEP 2 - Otsu picks the threshold from the histogram
T, otsu = None, None  # TODO 2: Otsu threshold; keep the returned T
print(f"Otsu chose T = {T:.0f}")

# STEP 3 - adaptive: a different threshold for every neighbourhood
mean = None  # TODO 3: adaptive MEAN threshold (BLOCK, C)
