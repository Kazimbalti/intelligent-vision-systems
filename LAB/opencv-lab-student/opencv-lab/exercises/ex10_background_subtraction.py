...
bg = None  # TODO 1: create a MOG2 subtractor with shadow detection
...
while True:
    ...
    raw = None  # TODO 2: apply the subtractor to the frame
    _, fg = None, None  # TODO 3: keep only 255 (drop shadows at 127)
    fg = None  # TODO 4: remove speckle noise with a morphological opening
    ...
    for c in contours:
        if cv2.contourArea(c) < args.min_area:
            continue
        x, y, w, h = None, None, None, None  # TODO 5: bounding box of the moving blob
