...
bright_cv = None  # TODO 1: brighten scene by 80 with cv2.add
...
for alpha in (0.25, 0.5, 0.75):
    pass  # TODO 2: blend A and B with weights alpha and 1 - alpha
...
_, t_bin = None, None  # TODO 3: THRESH_BINARY at 127
...
AND = None  # TODO 4: AND of the two masks
...
sun_only = None  # TODO 5: keep only the pixels where mask is white
