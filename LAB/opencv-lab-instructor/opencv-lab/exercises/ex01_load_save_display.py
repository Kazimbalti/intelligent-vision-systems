...
img = None  # TODO 1: read data/scene.jpg with cv2.imread
if img is None:
    raise FileNotFoundError("img is None: finish STEP 1 (or check the path)")
print("shape:", img.shape, " dtype:", img.dtype)
h, w = None, None  # TODO 2: unpack the height and width from img.shape
...
gray = None  # TODO 3: read scene.jpg again with cv2.IMREAD_GRAYSCALE
...
pass  # TODO 4: save img as output/scene_copy.png
cv2.imwrite(out("scene_q90.jpg"), img, [cv2.IMWRITE_JPEG_QUALITY, 90])
pass  # TODO 5: save output/scene_q20.jpg with JPEG quality 20
